...
// Delete a segment
//   ea      - any address in the segment
//   flags   - combination of SEGDEL_... flags

success SegDelete       (long ea, long flags);
...
#endif
#define BPTATTR_EA   0    // starting address of the breakpoint
#define BPTATTR_SIZE 4    // size of the breakpoint (undefined if software breakpoint)
#define BPTATTR_TYPE 8    // type of the breakpoint
                          // Breakpoint types:
...
#define BPTATTR_COUNT 12  // how many times does the execution reach this breakpoint ?

#define BPTATTR_FLAGS 16  // Breakpoint attributes:
...
#define BPTATTR_COND  20  // Breakpoint condition
                          // NOTE: the return value is a string in this case

#ifdef __EA64__           // redefine the offsets for 64-bit version
#define BPTATTR_SIZE   8
#define BPTATTR_TYPE  16
#define BPTATTR_COUNT 20
#define BPTATTR_FLAGS 24
#define BPTATTR_COND  28
#endif
#ifdef _notdefinedsymbol
...
#endif
#define AddBpt(ea) AddBptEx(ea, 0, BPT_SOFT)
#ifdef _notdefinedsymbol
...
//begin: added by Song  @LIAFA      
#define WriteLST(file,ea1,ea2) \
      GenerateFile(OFILE_LST,fopen(file,"a"), ea1, ea2, 0)
//end: added by Song  @LIAFA              
